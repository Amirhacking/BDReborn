...
♦️Creator @Refigh_heh
♦️Channel @iranize_link
]]
sendMessage(msg.chat_id,msg.id,1,text1,1,"html")
end

if text:match("^تسلا$") and chat_type == 'group' then
local text1 =[[
...
sendMessage(msg.chat_id, 0, 1,"حله اماده خدمتم لطفا روشنم کن با دستور | تسلا پاشو|\n همچنین دستور راهنمای ربات هم \n `تسلا راهنماییم کن`\n میباشد", 1, "md")
end
assert (tdbot_function ({
_ = "getUser",
user_id = owner_id
...
--Set Config
if text:match("^پیکربندی$") or text:match("^/start@iranize_link$")then
set_config(msg)
...
if text:match("^تسلا بی ادب شو$")and is_owner(msg) and is_JoinChannel(msg) then
redis:set("bot:ans"..msg.chat_id,true)
sendMessage(msg.chat_id,msg.id,1,"بی ادب شدم حله",1,"html")
end
if text:match("^تسلا با ادب شو$") and is_owner(msg) and is_JoinChannel(msg) then
redis:del("bot:ans"..msg.chat_id)
sendMessage(msg.chat_id,msg.id,1,"چشم با ادب میشم",1,"html")
end
if text:match("تسلا بکنش") and is_mod(msg) then
...
if text:match("^تسلا بخواب$") and is_mod(msg) and is_JoinChannel(msg) then
...
elseif text:match("^تسلا پاشو$") and is_mod(msg)and is_JoinChannel(msg) then
...
if text:match("^تسلا ساعت عاشقی رو فعال کن$") and is_JoinChannel(msg) and is_mod(msg) then
...
if text:match("^تسلا ساعت عاشقی رو غیرفعال کن$") and is_JoinChannel(msg) and is_mod(msg) then
...
if text:match("^تسلا بازی (.*)$") and is_JoinChannel(msg) and CMD then
local input = text:match("^تسلا بازی (.*)$")
if input == "کاغذ" then
if R == 'rock' then 
...
if text:match("^تسلا فالمو بگیر$") and is_JoinChannel(msg) and CMD then
...
--
--FazSangin Command
elseif text:match("^تسلا جمله فازسنگین بفرست$") and is_JoinChannel(msg) and CMD then
res = http.request('https://api.bot-dev.org/sangin/')
sendMessage(msg.chat_id,msg.id, 1,res, 1, 'md')
--
---Shabih Command
elseif text:match("^تسلا به نظرت شبیه کیم$") and is_JoinChannel(msg) and CMD then
if redis:get("bot:ans"..msg.chat_id) == nil then
...
elseif text:match("^تسلا هوای (.*)$") and is_JoinChannel(msg) and CMD then
local city = text:match("^تسلا هوای (.*)$")
textz = get_weather(city)
if not textz then
sendMessage(msg.chat_id, 0, 1,"مکان وارد شده💩", 1, "html")
end
sendMessage(msg.chat_id, 0, 1,textz, 1, "html")
elseif text:match("^تسلا صلوات$")and is_JoinChannel(msg) and CMD then
sendMessage(msg.chat_id,msg.id, 1,"ٱللَّهُمَّ صَلِّ عَلَىٰ مُحَمَّدٍ وَآلِ مُحَمَّد☺️📿", 1, 'md')
elseif text:match("^تسلا من کیم$") and is_JoinChannel(msg) and CMD then
if redis:get("bot:ans"..msg.chat_id) == nil then
...
elseif text:match("^تسلا به نظرت شغلم چیه$") and is_JoinChannel(msg) and CMD then
if redis:get("bot:ans"..msg.chat_id) == nil then
...
elseif text:match("^تسلا یه جوک بگو$") and is_JoinChannel(msg) and CMD then
res = http.request('http://api.bot-dev.org/jock/')
sendMessage(msg.chat_id,msg.id, 1,res, 1, 'md')
elseif text:match("^تسلا یه سخن بگو از بزرگان$") and is_JoinChannel(msg) and CMD then
res = http.request('http://abolfazl.senatorhost.com/Api/Sokhan.php')
sendMessage(msg.chat_id,msg.id, 1,res, 1, 'md')
elseif text:match("^تسلا یه چیستان بگو$") and is_JoinChannel(msg) and CMD then
res = http.request('http://abolfazl.senatorhost.com/Api/Chistan.php')
sendMessage(msg.chat_id,msg.id, 1,res, 1, 'md')
elseif text:match("^تسلا یچی بگو ندونم$") and is_JoinChannel(msg) and CMD then
res = http.request('https://api.bot-dev.org/danestani/')
sendMessage(msg.chat_id,msg.id, 1,res, 1, 'md')
elseif text:match("^تسلا اخبار بگو$") and is_JoinChannel(msg) and CMD then
...
sendMessage(msg.chat_id,msg.id, 1,text, 1, 'md')
elseif text:match("^تسلا یه شعر بگو$") and is_JoinChannel(msg) and CMD then
if redis:get("bot:ans"..msg.chat_id) == nil then
...
elseif text:match("^تسلا بچه کجام$") and is_JoinChannel(msg) and CMD then
if redis:get("bot:ans"..msg.chat_id) == nil then
res = http.request('https://abolfazl.senatorhost.com/TeslaApi/koja.php')
sendMessage(msg.chat_id,msg.id, 1,res, 1, 'md')
else
res = http.request('https://abolfazl.senatorhost.com/Api/Kojam.php	.php')
sendMessage(msg.chat_id,msg.id, 1,res, 1, 'md')
end
elseif text:match("^تسلا زنم چطوریه$") and is_JoinChannel(msg) and CMD then
if redis:get("bot:ans"..msg.chat_id) == nil then
res = http.request('https://abolfazl.senatorhost.com/TeslaApi/Zan.php')
sendMessage(msg.chat_id,msg.id, 1,res, 1, 'md')
else
res = http.request('https://abolfazl.senatorhost.com/Api/Zan.php')
sendMessage(msg.chat_id,msg.id, 1,res, 1, 'md')
end
elseif text:match("^تسلا شوهرم کیه$") and is_JoinChannel(msg) and CMD then
if redis:get("bot:ans"..msg.chat_id) == nil then
res = http.request('https://abolfazl.senatorhost.com/TeslaApi/shohar.php')
sendMessage(msg.chat_id,msg.id, 1,res, 1, 'md')
else
res = http.request('https://abolfazl.senatorhost.com/Api/Mard.php')
sendMessage(msg.chat_id,msg.id, 1,res, 1, 'md')
end
elseif text:match("^تسلا چطوری میمیرم$") and is_JoinChannel(msg) and CMD then
if redis:get("bot:ans"..msg.chat_id) == nil then
res = http.request('https://abolfazl.senatorhost.com/TeslaApi/marg.php')
sendMessage(msg.chat_id,msg.id, 1,res, 1, 'md')
else
res = http.request('https://abolfazl.senatorhost.com/Api/Marg.php')
sendMessage(msg.chat_id,msg.id, 1,res, 1, 'md')
end
elseif text:match("^تسلا چطوری خودمو بکشم$") and is_JoinChannel(msg) and CMD then
if redis:get("bot:ans"..msg.chat_id) == nil then
res = http.request('https://abolfazl.senatorhost.com/TeslaApi/khodkoshi.php')
sendMessage(msg.chat_id,msg.id, 1,res, 1, 'md')
else
res = http.request('http://abolfazl.senatorhost.com/Api/Khodkoshi.php')
sendMessage(msg.chat_id,msg.id, 1,res, 1, 'md')
end
elseif text:match("^تسلا بچم چیه$") and is_JoinChannel(msg) and CMD then
if redis:get("bot:ans"..msg.chat_id) == nil then
res = http.request('https://abolfazl.senatorhost.com/TeslaApi/bache.php')
sendMessage(msg.chat_id,msg.id, 1,res, 1, 'md')
else
res = http.request('https://abolfazl.senatorhost.com/Api/Bache.php')
sendMessage(msg.chat_id,msg.id, 1,res, 1, 'md')
end
elseif text:match("^تسلا ماشینم چیه$") and is_JoinChannel(msg) and CMD then
if redis:get("bot:ans"..msg.chat_id) == nil then
res = http.request('https://abolfazl.senatorhost.com/TeslaApi/car.php')
sendMessage(msg.chat_id,msg.id, 1,res, 1, 'md')
else
res = http.request('https://abolfazl.senatorhost.com/Api/Mashin.php')
sendMessage(msg.chat_id,msg.id, 1,res, 1, 'md')
end
elseif text:match("^تسلا$") and CMD then
if redis:get("bot:ans"..msg.chat_id) == nil then
res = http.request('https://abolfazl.senatorhost.com/TeslaApi/Robot.php')
sendMessage(msg.chat_id,msg.id, 1,res, 1, 'md')
else
res = http.request('https://abolfazl.senatorhost.com/Api/Tesla.php')
sendMessage(msg.chat_id,msg.id, 1,res, 1, 'md')
end
...
if text:match("^تسلا اومد$") and is_JoinChannel(msg) and CMD then
sendMessage(msg.chat_id,msg.id,1,"اوهوم اومدم",1,"html")
end
if text:match("^تسلا راهنماییم کن$") and chat_type == 'supergroup' and CMD and is_JoinChannel(msg) then
if redis:get("bot:ans"..msg.chat_id) == nil then
local text2 = [[
▪️سلام گلم مرسی که داری ازمن استفاده میکنی🤪

♦️لطفا برای نمایش راهنمای مدیریتی بزن
`تسلا دستورات مدیریتت چیه`

♦️و برای راهنمای فان ربات بزن
`تسلا دستورات فانت چیه`
]]
...
if text:match("^تسلا دستورات مدیریتت چیه$") and chat_type == 'supergroup' and CMD and is_JoinChannel(msg) then
if redis:get("bot:ans"..msg.chat_id) == nil then
local text3 = [[
...
if text:match("^تسلا دستورات فانت چیه$") and chat_type == 'supergroup' and CMD and is_JoinChannel(msg) then
if redis:get("bot:ans"..msg.chat_id) == nil then
local text2 = [[
🍃 `تسلا فالمو بگیر`
📍 برای دریافت فال
❖❖❖❖❖❖❖❖❖❖❖❖❖❖❖
🍂 `تسلا جمله فازسنگین بفرست`
...
if text:match("^تسلا وضعیت ترافیک (.*)$") and is_JoinChannel(msg) and CMD then
local cytr = text:match("^تسلا وضعیت ترافیک (.*)$")
...
-- Vasiat
if text:match("^تسلا وضعیت من$") and is_JoinChannel(msg) and CMD then
if redis:get("bot:ans"..msg.chat_id) == nil then
...
------------------------------
if text:match("تسلا عکس بساز (.*)") and CMD and is_JoinChannel(msg) then
input = text:match("تسلا عکس بساز (.*)")
...
if text:match("^تسلا پیام پاک کن (.*)$") and is_JoinChannel(msg) and is_mod(msg) then
local limit = text:match("^تسلا پیام پاک کن (.*)$")
...
-------------------------------------------------------------------------
--[[if text:match("^تسلا معنی (.*)$") and CMD and is_JoinChannel(msg) then
local input = text:match("^تسلا معنی (.*)$")
...
------------------------------------------------------------------------
if text:match("^تسلا عکس رندوم بفرست$") and CMD and is_JoinChannel(msg) then
...
-------------------------------------------------------------------------
if text:match("^تسلا مقامشو بکن (.*)$") and tonumber(reply_id) > 0 and is_JoinChannel(msg) and is_mod(msg) then
local test = text:match("^تسلا مقامشو بکن (.*)$")
...
if text:match("^تسلا مقامم چیه$") and tonumber(reply_id) == 0 and is_JoinChannel(msg) and CMD then
...
elseif text:match("^تسلا مقام این چیه$") and tonumber(reply_id) > 0 and is_JoinChannel(msg) and CMD then
function idreply(extra, result)
...
-------------------------------------------------------------------------
if text:match("^تسلا ساعت چنده$") and is_JoinChannel(msg) and CMD then
...
if text:match("^تسلا اینو سنجاق کن$") and tonumber(reply_id) > 0 and is_mod(msg) and is_JoinChannel(msg)then
...
if text:match("^تسلا سنجاقو حذف کن$") and is_mod(msg) and is_JoinChannel(msg) then
if redis:get("bot:ans"..msg.chat_id) == nil then
...
if text:match("^تسلا اینو عکس کن$")  and tonumber(reply_id) > 0 and CMD and is_JoinChannel(msg) then
...
if text:match("^تسلا اینو استیکر کن$")  and tonumber(reply_id) > 0 and CMD and is_JoinChannel(msg) then
function tophoto(extra, result)
...
if text:match("^تسلا لینک رو قفل کن$") and is_mod(msg) and is_JoinChannel(msg) then
...
elseif text:match("^تسلا فوروارد رو قفل کن$")and is_mod(msg) and is_JoinChannel(msg) then
...
elseif text:match("^تسلا رباتو قفل کن$") and is_mod(msg) and is_JoinChannel(msg) then
...
elseif text:match("^تسلا استیکر رو قفل کن$") and is_mod(msg)and is_JoinChannel(msg) then
...
if text:match("^تسلا قفل لینک رو بازکن$") and is_mod(msg)and is_JoinChannel(msg)then
...
elseif text:match("^تسلا قفل فوروارد رو بازکن$") and is_mod(msg)and is_JoinChannel(msg)then
...
elseif text:match("^تسلا قفل ربات رو بازکن$") and is_mod(msg)and is_JoinChannel(msg)then
...
elseif text:match("^تسلا قفل استیکر رو بازکن$") and is_mod(msg)and is_JoinChannel(msg)then
...
----Force Join
if text:match("^تسلا دعوت اجباری رو فعال کن$") and is_mod(msg) and is_JoinChannel(msg)then
...
elseif text:match("تسلا دعوت اجباری رو غیرفعال کن") and is_mod(msg) and is_JoinChannel(msg)then
...
---- Cleans
if text:match("تسلا پاکسازی دیلیت اکانتی ها") and is_JoinChannel(msg)and is_mod(msg) then
...
-----------------
if text:match("تسلا پاکسازی بلک لیست") and is_JoinChannel(msg) and is_mod(msg) then
...
-----------------
if text:match("تسلا رباتارو پاک کن") and is_mod(msg) and is_JoinChannel(msg) then
...
--------------
if text:match("^تسلا خوشامدگویی رو فعال کن$") and is_mod(msg) and is_JoinChannel(msg) then
...
elseif text:match("^تسلا خوشامدگویی رو غیرفعال کن$") and is_mod(msg) and is_JoinChannel(msg) then
...
if text:match("^تسلا چیکارا میکنی$") or text:match("^لورچی کار میکنی$") or text:match("^تسلا چه کارمیکنی$") or text:match("^تسلا چه کار میکنی$") or text:match("^چه کارمیکنی تسلا$") or text:match("^چیکار میکنی تسلا$")or text:match("^چیکارا میکنی تسلا$")or text:match("^چ میکنی تسلا$")or text:match("^تسلا چ میکنی$")and CMD then
if redis:get("bot:ans"..msg.chat_id) == nil then
local datebase ={
...
if text:match("^تسلا بوس بده$") or text:match("^تسلا بوس$") or text:match("^تسلا بوس میدی$") or text:match("^بوس بده تسلا$") or text:match("^بوس تسلا$") or text:match("^بوس میدی تسلا$")and CMD then
if redis:get("bot:ans"..msg.chat_id) == nil then
local datebase ={
"🥰😘اینم بوس",
"عه عه زشته🙊🙈😘",
...
if text:match("^تسلا بخند$") or text:match("^بخند تسلا$") and CMD then
if redis:get("bot:ans"..msg.chat_id) == nil then
local datebase ={
...
if text:match("^تسلا گریه کن$") or text:match("^گریه کن تسلا$") and CMD then
if redis:get("bot:ans"..msg.chat_id) == nil then
local datebase ={
...
if text:match("^تسلا بده$") and CMD then
if redis:get("bot:ans"..msg.chat_id) == nil then
local datebase ={
"چی میخوری بدم : )؟",
...
local datebase ={
"/home/Tesla/goz/goz1.ogg",
"/home/Tesla/goz/goz2.ogg",
"/home/Tesla/goz/goz3.ogg",
"/home/Tesla/goz/goz4.ogg",
"/home/Tesla/goz/goz5.ogg",
"/home/Tesla/goz/goz6.ogg",
"/home/Tesla/goz/goz7.ogg",
"/home/Tesla/goz/goz8.ogg",
"/home/Tesla/goz/goz9.ogg",
"/home/Tesla/goz/goz10.ogg"
}
local file = datebase[math.random(#datebase)]
sendVoice(msg.chat_id,msg.id,file,0,waveform,"@iranize_link")
end
if text:match("^تسلا بمیر$") or text:match("^بمیر تسلا$")and CMD then
if redis:get("bot:ans"..msg.chat_id) == nil then
local datebase ={
"دلت میاد من بمیرم :( ؟",
